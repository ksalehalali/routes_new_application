...
import '../../business_logic/cubit/register_cubit/register_state.dart';
                                ...
                                Container(
                                  ...
                                  child: InternationalPhoneNumberInput(
                                    onInputChanged: (PhoneNumber number) {
                                      ...
                                      phoneNum =number.phoneNumber!.replaceAll("+", "");
                                    },
...
//                            textFieldController: controller,
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (!isConnected ==true) {
                                            ...
                                            if (passwordController.text.isEmpty) {
                                              _showDialogBoxWrongPassword(context);
                                            } else {
                                              if (!regex.hasMatch(passwordController.text)) {
                                                _showDialogBoxWrongPassword(context);
                                              } else {
                                               var login =  cubit.login(phoneNum, passwordController.text);
                                ...
                                Row(
                                  ...
                                  children: [
                                    BlocBuilder<RegistrationBloc, RegisterStates>(
                                      builder: (context , state){
                                        if(state is TryingLogin){
                                          return const CircularProgressIndicator();
                                        }else if(state is LoggedIn){
                                          return   Text("--${state.userInfo['role'][0]}");
                                        }else{
                                          return Container();
                                        }
                                      },
  ...
  _showDialogBoxWrongPassword(BuildContext context) => showCupertinoDialog<String>(
        context: context,
